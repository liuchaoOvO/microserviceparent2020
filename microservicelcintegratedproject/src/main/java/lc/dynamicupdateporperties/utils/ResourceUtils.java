...
public class ResourceUtils extends Object {
    ...
    /**
     * Returns a resource on the classpath as a Stream object
     * note:there will no cache the stram object.Every time you call this method,
     * the file will be reopend if you need to get the configuration dynamically
     ...
     * @throws IOException If the resource cannot be found or read
     */
    public static InputStream getResourceOpenStream(String resource) throws IOException {
